...
export default function Footer() {
  const [firstExpanded, setFirstExpanded] = useToggle();
  const [secondExpanded, setSecondExpanded] = useToggle();
  const [thirdExpanded, setThirdExpanded] = useToggle();
  const [fourthExpanded, setFourthExpanded] = useToggle();
  const [fifthExpanded, setFifthExpanded] = useToggle();

  return (
    <footer className="footer">
      <nav aria-label="Global-Footer" className="container">
        <div className="footer__nav__main__container">
          <div className="footer__nav__main__mobile">
            <div
              className="footer__nav__main__mobile__toggler__container"
              onClick={() => {
                setFirstExpanded();
              }}
            >
              <h2
                className="footer__nav__main__mobile__toggler__header"
                tabIndex={-1}
              >
                About Us
              </h2>
              <button
                ...
                className="footer__nav__main__mobile__toggler__button"
            ...
            <AnimatePresence>
              {firstExpanded && (
                ...
                >
                  <div>
                    <ul className="footer__nav__main__mobile__expander__list">
                      <li className="">
                        <a
                          className="footer__nav__main__mobile__expander__list__item__link"
          ...
          <div className="footer__nav__main__desktop">
            <h2 className="footer__nav__main__desktop__header" tabIndex={-1}>
              About Us
            </h2>
            <ul className="footer__nav__main__desktop__list">
              <li className="">
                <a
                  className="footer__nav__main__desktop__list__item__link"
                  href="https://www.starbucks.com/about-us/"
                >
                  Our Company
                </a>
                ...
                >
                  <ul className="footer__nav__main__mobile__expander__list">
                    <li className="">
                      <a
                        className="footer__nav__main__mobile__expander__list__item__link"
                        href="https://www.starbucks.com/responsibility/people/"
                      >
                        People
                      </a>
                    </li>
          ...
          <div className="footer__nav__main__mobile">
            ...
            >
              ...
              <button
                aria-label="Expand Ways To Order"
                className="footer__nav__main__mobile__toggler__button"
                aria-expanded={false}
              >
                <motion.svg
        ...
        <ul className="footer__icon__list">
          <li className="footer__icon__list__item">
            <a
              aria-label="spotify"
              className="footer__icon__list__item__link"
              href="https://open.spotify.com/user/starbucks"
            >
              <svg
                aria-hidden={true}
                className="footer__icon__list__item__icon"
                focusable={false}
                viewBox="0 0 24 24"
              >
        ...
        <ul className="footer__last-links-list">
          <li className="footer__last-links-list__item">
            <a
              className="footer__last-links-list__item__link"
          ...
          <li className="footer__last-links-list__item">
            <span
              aria-hidden={true}
              className="footer__last-links-list__item__link__seperator"
            >
              |
            </span>
            <a
          ...
          <li className="footer__last-links-list__item">
            ...
            <button className="footer__last-links-list__item__link">
              Cookie Preferences
            </button>
          </li>
        </ul>
